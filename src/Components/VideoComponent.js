...
import searchImage from './logo.png'

import './VideoComponent.css'
import exportedGlassesModel1 from '../Glasses/glasses1.json'
import exportedGlassesModel2 from '../Glasses/glasses1 (1).json'

// const exportedGlassesModel = JSON.parse(exportedGlassesModels);
...
const VideoComponent = (props) => {
    ...
    const set_glassesModel = (sku) => {
        ...
        JEELIZVTOWIDGET.load_modelStandalone(exportedGlassesModel1, function(){
            console.log('INFO: EXPORTED MODEL LOADED');
            });
      }
    ...
    return (
        <div ref={refPlaceHolder} className='JeelizVTOWidget'>
            ...
            <div ref={refChangeModel} className='JeelizVTOWidgetControls JeelizVTOWidgetChangeModelContainer'>
                <button className='JeelizVTOWidgetButton' onClick={set_glassesModel.bind(this, exportedGlassesModel1)}>Model 1</button>
                <button className='JeelizVTOWidgetButton' onClick={set_glassesModel.bind(this, exportedGlassesModel2)}>Model 2</button>
